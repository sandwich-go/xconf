...
func init() {
	...
	SetProviderByFieldType(typeNameMapStringString, func(valPtr interface{}, stringAlias func(s string) string) flag.Getter {
		return NewMapStringString(valPtr, stringAlias)
	})
}
