...
//go:generate optiongen --option_with_struct_name=false --new_func=NewTestConfig --xconf=true --empty_composite_nil=true
func ConfigOptionDeclareWithDefault() interface{} {
	return map[string]interface{}{
		...
		"TimeDurations":   []time.Duration([]time.Duration{time.Second, time.Second}),
